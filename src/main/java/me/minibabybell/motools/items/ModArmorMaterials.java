package me.minibabybell.motools.items;

import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import me.minibabybell.motools.ModItems;
...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    COPPER("copper", 15, new int[]{1, 4, 5, 2}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
